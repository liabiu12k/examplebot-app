...
# Preguntas y respuestas (por categoria, solo 10, Reumatologia,Patología Apendicular y cardiologia )
...
app = ApplicationBuilder().token("7648845471:AAFY6FhamIAUUNkEPgqduZj12o7f6ZyNrew").build()  # link del token 
...
if __name__ == "__main__":
    ...
    # funcion de la ejecucion corregida del bot (al devolver un true)